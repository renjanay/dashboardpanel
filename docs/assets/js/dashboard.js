		...
		$.get(ipurl, (data) => {
			...
			fetch(file)
				...
				.then((data) => {
					...
					$('#wrapper-loc').text(city)
					$('#wrapper-temp').text(temp + "°C")
					$('#wrapper-condition').text(description)
					$('#wrapper-pressure').text('Pressure ' + pressure)
					$('#wrapper-humidity').text('Humidity ' + humidity)
					

					switch (main) {
						case "Snow":
							$('#weather-img').attr('assets/images/weather/snow.gif')
							break;
						case "Clouds":
							$('#weather-img').attr('assets/images/weather/clouds.gif')
							break;
						case "Fog":
							$('#weather-img').attr('assets/images/weather/fog.gif')
							break;
						case "Rain":
							$('#weather-img').attr('assets/images/weather/rain.gif')
							break;
						case "Clear":
							$('#weather-img').attr('assets/images/weather/clear.gif')
							break;
						case "Thunderstorm":
							$('#weather-img').attr('assets/images/weather/thunderstorm.gif')
							break;
						default:
							$('#weather-img').attr('assets/images/weather/clear.gif')
							break;
